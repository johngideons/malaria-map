...
function App() {
  ...
  useEffect(() => {
    ...
    map.current.on('load', async () => {
      ...
      const response = await fetch('/malaria-map/json/malaria_v8.json');
      ...
      map.current.addSource('ee-elevation-mask', {
        type: 'raster',
        tiles: ['https://earthengine.googleapis.com/v1/projects/ee-jsaita47/maps/6d36de1835db201b8c600e073d910d30-cfa370032360bbac98cac60d45b3847b/tiles/{z}/{x}/{y}'],
        tileSize: 256
      });
      map.current.addLayer({
